...
function attachmentFileIcon(mimeType: string) {
  if (mimeType === 'application/x-canva')
    return <img src={canvaSvg} alt="Canva" className="w-4 h-4 rounded shrink-0" />
    ...
    <div className="flex flex-col h-full">
                ...
                <>
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex items-center gap-2 flex-1 px-4 py-2.5 rounded-xl border-2 border-dashed border-[#D0D5DD] dark:border-[#3A3C4A] text-[12.5px] font-medium text-[#667085] dark:text-[#8B92A8] hover:border-[#2563EB] hover:text-[#2563EB] hover:bg-[#EFF6FF] dark:hover:bg-[#13141A] transition-all disabled:opacity-50"
                    >
      ...
      {showCanvaPicker && (
        <CanvaPickerModal
          ...
          onSelect={(design) => {
            linkCanvaDesign.mutate(design, {
              onSuccess: () => setShowCanvaPicker(false),
            })
          }}
        />
      )}

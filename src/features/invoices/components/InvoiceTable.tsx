import { ArrowUpRight, ChevronUp, ChevronDown, ChevronsUpDown, Trash2, Ban, LayoutTemplate } from 'lucide-react'
...
interface Props {
  ...
  /** U11/R2: opens SaveAsTemplateModal for this Invoice row */
...
export default function InvoiceTable({ invoices, sortBy, sortDir, onSort, onOpen, onDelete, onVoid, onSaveAsTemplate }: Props) {
  return (
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-all">
                      {onSaveAsTemplate && (
                        <button
                          onClick={e => { e.stopPropagation(); onSaveAsTemplate(inv) }}

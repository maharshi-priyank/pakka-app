  ...
  return (
    <div className="space-y-7">
      ...
      <section>
        ...
        <p className="text-[12.5px] text-[#667085] dark:text-[#8B92A8] mb-4 ml-[23px]">
          Get pinged on your phone the moment a client pays, signs, or opens your work — even when ClearWork is closed. Install ClearWork to your home screen first for the best experience.
        </p>

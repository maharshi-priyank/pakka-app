...
const STAGES = [
  { key: 'ENQUIRY',       label: 'Enquiry',       color: '#98A2B3', bg: '#F2F4F7',  textColor: '#667085' },
  { key: 'PROPOSAL_SENT', label: 'Proposal Sent', color: '#6366F1', bg: '#EEF2FF',  textColor: '#4338CA' },
  { key: 'NEGOTIATING',   label: 'Negotiating',   color: '#F59E0B', bg: '#FFFAEB',  textColor: '#B54708' },
  { key: 'WON',           label: 'Won',           color: '#12B76A', bg: '#ECFDF3',  textColor: '#027A48' },
  { key: 'LOST',          label: 'Lost',          color: '#F04438', bg: '#FEF3F2',  textColor: '#B42318' },
]
        ...
        {STAGES.map((stage, idx) => {
          ...
          return (
            <div key={stage.key} className="flex items-center gap-3">
              <div className={cn(
                'text-[11px] font-semibold rounded-md px-2 py-0.5 shrink-0 w-[100px] text-center',

...
const STORAGE_KEY = 'clinekt-pwa-install-dismissed-at'
const SESSION_KEY = 'clinekt-session-count'
          ...
          >
            ...
            <ol className="space-y-3">
              ...
              <li className="flex items-start gap-3">
                ...
                <p className="text-[13px] text-[#344054] dark:text-[#C2C8D8]">
                  Tap <span className="font-semibold">Add</span> in the top right. Clinekt is now on your home screen.
                </p>
              </li>
            </ol>
